...
double generateRandomNumber() {
	...
	return dis(random_number); // √енерируем и возвращаем случайное число от 0 до 1
}
...
int main()
{
	sf::VideoMode desktop = sf::VideoMode::getDesktopMode(); // ѕолучаем размер рабочего стола
