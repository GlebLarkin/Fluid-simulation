...
void Particle::Earth_Gravity() { this->vy += g; } //its really gravity, makes the particle fall faster
...
sf::CircleShape Particle::GetCircle() const { return this->circle; } //returns the circle of the particle
