...
public:
	...
	float Find_particles_pressure(Particle& A, Pressure_map_cell& cell, Data& d);
	...
	unsigned int find_this_cell_number_x(float x_, Data & d) 
	{
		if (x_ + d.r <= 0) return 0;
